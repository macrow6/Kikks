...
namespace codeneric\phmm\validate {
  ...
  class Handler {
    ...
    private static function init($schema, $baseUrl = null) {
      if (!\hacklib_cast_as_boolean(is_null(self::$storage))) {
        return self::$storage;
      }
      if (\hacklib_cast_as_boolean(is_null($baseUrl))) {
  ...
  function protected_file_request($data) {
    $func = function($data) {
  ...
  function get_comments_count($data) {
    $func = function($data) {
  ...
  function get_canned_email_preview($data) {
    $func = function($data) {
      list($d, $v) =
        Handler::validate($data, "get_canned_email_preview.json");
      return /* UNSAFE_EXPR */ array($d, $v);
    };
    list($d, $v) = $func($data);
    \HH\invariant(
  ...
  function send_canned_email($data) {
    $func = function($data) {
  ...
  function client_from_client($data) {
    $func = function($data) {
  ...
  function project_from_admin($data) {
    $func = function($data) {
  ...
  function project_to_client($data) {
    $func = function($data) {
  ...
  function project_protection($data) {
    $func = function($data) {
  ...
  function get_download_zip_parts($data) {
    $func = function($data) {
  ...
  function client_project_access($data) {
    $func = function($data) {
  ...
  function canned_email_history($data) {
    $func = function($data) {
