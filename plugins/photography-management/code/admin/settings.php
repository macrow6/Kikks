...
namespace codeneric\phmm\base\admin {
  ...
  class Settings {
    ...
    public static function render_add_submenu_page() {
      ...
      $link = "https://www.facebook.com/groups/1529247670736165/";
      $tmp =
        \__(
          "Join our <a style='color: coral' target='_blank' href='%s'>facebook group</a> to get immediate help or get in contact with other photographers using WordPress!",
          "phmm"
        );
      $fbJoin = \sprintf("<strong>".$tmp."</strong>", $link);
      echo
