...
namespace codeneric\phmm\base\includes {
  ...
  class Phmm {
    ...
    private function define_admin_hooks() {
      ...
      $this->loader
        ->add_action("admin_init", $plugin_admin, "update_database");
      $this->loader->add_action(
        "admin_init",
        $plugin_admin,
      ...
      $this->loader->add_action(
        "add_meta_boxes_".$config[\hacklib_id("project_post_type")],
        $plugin_admin,
      ...
      $this->loader->add_filter(
        "manage_".$config[\hacklib_id("client_post_type")]."_posts_columns",
        $frontendHandler,
      ...
      $this->loader->add_filter(
        "manage_".$config[\hacklib_id("project_post_type")]."_posts_columns",
        $frontendHandler,
      ...
      $this->loader
        ->add_action("deleted_user", Client::class, "delete_client");
      $this->loader->add_action(
    ...
    private function define_public_hooks() {
      ...
      if (\hacklib_cast_as_boolean(
            \codeneric\phmm\Utils::wp_version_is_at_least("4.7.0")
          )) {
        $this->loader->add_action(
